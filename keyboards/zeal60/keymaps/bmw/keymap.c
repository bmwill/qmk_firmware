// Custom Layout for the Zeal60
//
// Flashing Instructions:
// 1. Build firmware from root:
//    $ make zeal60-bmw
// 2. Put Zeal60 into bootloader mode by holding down ESC and SPACE while plugging in the USB
// 3. Flash the firmware:
//    $ dfu-programmer atmega32u4 erase
//    $ dfu-programmer atmega32u4 flash .build/zeal60_bmw.hex
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  // ├─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┤
  // │ FN1 │L_ALT│L_GUI│█████│█████│█████│█████│ SPC │█████│█████│R_GUI│R_ALT│RCTRL│ FN2 │
  // └─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┘
  ...
  [0] = {
    ...
    {FN_MO13, KC_LALT, KC_LGUI, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_SPC,  KC_NO,   KC_NO,   KC_RGUI, KC_RALT, KC_RCTL, FN_MO23}
  },
  ...
  // 3: zeal60 Configuration layer
  // ┌─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┐
  // │     │FX_DN│FX_UP│H1_DN│H1_UP│H2_DN│H2_UP│     │     │     │     │BR_DN│BR_UP│     │
  // ├─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┤
  // │     │     │     │S1_DN│S1_UP│S2_DN│S2_UP│     │     │     │     │SP_DN│SP_UP│     │
  // ├─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┤
  // │     │     │     │     │     │     │     │     │     │     │     │     │     │█████│
  // ├─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┤
  // │     │▒▒▒▒▒│     │     │     │     │     │     │     │     │     │     │     │     │
